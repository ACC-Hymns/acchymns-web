...
// / <- home
{
    ...
    head.insertAdjacentHTML("beforeend", generateMetaTags("ACCHymns", "A website for the Apostolic Christian Church of America hymnbook", "", "assets/icons/180x180.png", "website"));
    // fs.writeFileSync(`${dist_dir}/index.html`, dup.toString());
}

// /selection/* <- book selection
const books = ["ZH", "GH", "JH", "HG", "CH", "HZ", "ZG", "ZGE", "ZHJ", "ZHSP", "ZHG", "ZHH", "ZHR", "HS", "PC"];
