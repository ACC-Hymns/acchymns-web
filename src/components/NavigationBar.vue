...
<template>
    <nav class="nav" v-show="!hide_footer">
        <RouterLink to="/" class="nav__link" :class="{ 'nav__link--active': current_page == 'home' }">
            <img v-if="current_page == 'home'" class="ionicon nav__icon nav__icon--active" src="/assets/home.svg" />
        ...
        <RouterLink to="/search" class="nav__link" :class="{ 'nav__link--active': current_page == 'search' }">
            <img v-if="current_page == 'search'" class="ionicon nav__icon nav__icon--active" src="/assets/search.svg" />
        ...
        <RouterLink to="/bookmarks" class="nav__link" :class="{ 'nav__link--active': current_page == 'bookmarks' }">
            <img v-if="current_page == 'bookmarks'" class="ionicon nav__icon nav__icon--active" src="/assets/bookmark.svg" />
        ...
        <RouterLink to="/settings" class="nav__link" :class="{ 'nav__link--active': current_page == 'settings' }">
            <img v-if="current_page == 'settings'" class="ionicon nav__icon nav__icon--active" src="/assets/settings.svg" />
